...
export default function SobreMi() {
  ...
  return (
    /* Fijamos el min-h-screen y el fondo aquí para que cubra todo el viewport.
       Añadimos 'isolate' para evitar que se mezclen capas de color inferiores.
    */
    <div className="min-h-screen w-full bg-[#F0F0F0] isolate">
      <main className="w-full pb-32 pt-16 font-sans max-w-7xl mx-auto">
        ...
        <div className="max-w-4xl mx-auto px-6 space-y-24">
          ...
          <section className="pt-10">
            <div className="bg-white rounded-[3rem] p-8 md:p-16 border border-gray-100 shadow-xl shadow-[#6B5E70]/5 transition-all">
              {enviado ? (
                <div className="text-center py-10">
                  ...
                  <button 
                    ...
                    className="text-[10px] font-black uppercase tracking-widest text-[#6B5E70] border-b border-[#6B5E70] pb-1 hover:opacity-70 transition-opacity"
                  >
                    Enviar otro
                  </button>
                </div>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div className="space-y-2">
                        ...
                        <input 
                          ...
                          className="w-full bg-[#F0F0F0] border-none rounded-2xl px-6 py-4 text-[#6B5E70] placeholder:text-[#6B5E70]/30 font-bold focus:ring-2 focus:ring-[#6B5E70]/10 transition-all outline-none" 
                        />
                      </div>
                      <div className="space-y-2">
                    ...
                    <div className="space-y-2">
                      ...
                      <textarea 
                        ...
                        className="w-full bg-[#F0F0F0] border-none rounded-[2rem] px-6 py-5 text-[#6B5E70] placeholder:text-[#6B5E70]/30 font-bold focus:ring-2 focus:ring-[#6B5E70]/10 transition-all outline-none min-h-[150px] resize-none"
                      ></textarea>
                    </div>
                    ...
                    <button 
                      type="submit" 
                      disabled={loading} 
                      className="w-full md:w-auto px-12 bg-[#6B5E70] text-white font-black uppercase italic tracking-widest py-5 rounded-2xl hover:scale-105 active:scale-95 transition-all shadow-xl shadow-[#6B5E70]/20 disabled:opacity-50"
                    >
